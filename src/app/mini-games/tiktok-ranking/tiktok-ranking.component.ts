...
const ROUNDS: RankingRound[] = [
	...
	{
		question: "Qui aurait la vie la plus sulfureuse si on lisait ses DM ?",
		options: [
			"Evelynn",
			"Ahri",
			"LeBlanc",
	...
	{
		question: "Qui aurait la vie amoureuse la plus chaotique de tout Runeterra ?",
		options: [
			"Ahri",
			"Evelynn",
			"Xayah",
	...
	{
		question: "Qui ferait le plus de vues si on lui donnait un compte Snapchat sans filtre ?",
		options: [
			"Evelynn",
			"Miss Fortune",
			"Samira",
	...
	{
		question: "Qui aurait le plus de messages a supprimer avant que sa mere regarde son telephone ?",
		options: [
			"Ezreal",
			"Draven",
			"Jinx",
	...
	{
		question: "Qui serait le plus a l'aise a poil dans un sauna avec toute l'equipe ?",
		options: [
			"Braum",
			"Sett",
			"Olaf",
	...
	{
		question: "Qui aurait le plus de mal a expliquer son historique de recherche a la police ?",
		options: [
			"Singed",
			"Zac",
			"Viktor",
	...
	{
		question: "Qui gagnerait un concours de flirt le plus vite, sans dire un mot ?",
		options: [
			"Ahri",
			"Rakan",
			"Evelynn",
	...
	{
		question: "Qui aurait le plus de contenu embarrassant si on piratait son cloud ?",
		options: [
			"Teemo",
			"Yuumi",
			"Zoe",
